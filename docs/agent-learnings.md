...
|------|--------------|-----|-------------------|
| Fun / bubbly | **Fredoka** | Rounded terminals, soft geometry, clearly playful without being illegible | SIL OFL 1.1, Google Fonts |
| Elegant curved serif | **Cormorant** | High contrast, fluid curves, editorial elegance; pairs well with sculpt UI | SIL OFL 1.1, Google Fonts |
...
- **Bubbly:** Baloo 2 (rounder/heavier), Nunito (softer, less cartoon)
- **Elegant serif:** Fraunces (soft “wonky” curves, variable axes), Lora (warmer, less display), Instrument Serif (already used in demo HTML)
