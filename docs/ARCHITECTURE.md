...
```
         ...
         preset.pipeline =          preset.pipeline =
          "outline-deform"            "parametric"
                  │                       │
   DeformableOutlineWordmark           Wordmark
   (lib/sculpt.js:2463)                (lib/sculpt.js:1872)
                  │                       │
...
| 1872–2460 | `class Wordmark` | **Parametric pipeline.** Layout, render, drag, mouse-follow, `setText`, `setPreset`, `toSVG`, `toState`, `toInteractiveBundle`. |
